...
import { Shield, AlertTriangle, FileText, MapPin, GraduationCap, BarChart3, ChevronLeft, ChevronRight, Bell, User,  } from 'lucide-react';

const navGroups = [
  {
    label: 'PROTECTION',
    items: [
      { href: '/', icon: Shield, label: 'AI Scam Analyzer', badge: null },
      { href: '/emergency-mode', icon: AlertTriangle, label: 'Emergency Mode', badge: 'SOS' },
      { href: '/complaint-generator', icon: FileText, label: 'Complaint Generator', badge: null },
    ],
  },
  {
    label: 'COMMUNITY',
    items: [
      ...
      { href: '/learn', icon: GraduationCap, label: 'Cyber Learning', badge: null },
    ],
  },
  {
    label: 'ADMIN',
